...
require_once 'repository/rules/EmailRule.class.php';
require_once 'repository/rules/AlphanumericRule.class.php';
require_once 'repository/rules/MatchingRule.class.php';
require_once 'repository/rules/NumericRule.class.php';
